      ...
      {({ isToggle, toggleTheme }) => (
        <AuthContext.Consumer>
          {({ isAuthStatus, setLogin, setLouout }) => (
            <header className='px-4 lg:px-8 py-6 flex items-center justify-between flex-wrap  dark:bg-[#1C203B] text-gray-700 dark:text-gray-200 z-40'>
              ...
              {/* 🟨🟨🟨 UI For ==> Menu */}
              {!isAuthStatus ? (
                <nav className='hidden lg:block space-x-6 ml-auto'>
